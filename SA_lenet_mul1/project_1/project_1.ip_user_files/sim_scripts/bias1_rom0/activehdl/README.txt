...
#
# Generated by export_simulation on Wed Oct 23 12:37:20 +0200 2024
#
################################################################################
...
'-reset_run' switch to the './bias1_rom0.sh' script.

./bias1_rom0.sh -reset_run
...
./bias1_rom0.sh -noclean_files

For more information on the script, please type './bias1_rom0.sh -help'.
